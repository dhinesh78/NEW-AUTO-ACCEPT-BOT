    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup([[
                ...
                InlineKeyboardButton("𖣘 Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ", url="https://t.me/DP_BOTZ"),
        ...
        key = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("𖤍 Tʀʏ Aɢᴀɪɴ ༗", "DP_BOTZ")
                ]
            ]
        )
