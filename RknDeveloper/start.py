...
async def approve(bot, m : Message):
    ...
    try:
        ...
        await bot.send_video(kk.id,img, "**Hello {}!\nWelcome To {}\n\n__Pᴏᴡᴇʀᴅ Bʏ : @DP_BOTZ__**".format(m.from_user.mention, m.chat.title), reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("✛ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Cʜᴀɴɴᴇʟ ࿇", url=f"https://t.me/{rkn1.BOT_USERNAME}?startchannel=Bots4Sale&admin=invite_users+manage_chat")],[
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup([[
                ...
                InlineKeyboardButton("💌 Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ 💌", url="https://t.me/DP_BOTZ"),
        ...
        key = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("👍 Tʀʏ Aɢᴀɪɴ 👍", "DP_BOTZ")
                ]
            ]
        )
