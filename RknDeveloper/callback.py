...
‣ Dᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/MERSAL_DHINESH'>DP Dᴇᴠᴇʟᴏᴘᴇʀ</a>
...
‣ Bᴜɪʟᴅ Sᴛᴀᴛᴜs : ᴠ3.8.3 [sᴛᴀʙʟᴇ]</b>""",
	    reply_markup=InlineKeyboardMarkup( [[
               #⚠️ don't change source code & source link ⚠️ #
               InlineKeyboardButton("❣️ Sᴏᴜʀᴄᴇ Cᴏᴅᴇ ❣️", url="https://t.me/dpowner_bot")],[
               InlineKeyboardButton("→ Bᴀᴄᴋ", callback_data = "DP_BOTZ")
               ]]
            )
    )
